...
//获取我的钱包公告
func (miniSetService *MiniSetService) WalletNotice() (err error, notice string) {
	var set mini.MiniSet
	err = global.GVA_DB.First(&set).Error
	return err, set.WalletNotice
}

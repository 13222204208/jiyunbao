<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="类型ID">
         <el-input v-model="searchInfo.codeId" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="品类名称" prop="title" width="120" />
        <el-table-column align="left" label="类型ID" prop="codeId" width="120" />
        <el-table-column align="left" label="父id" prop="pid" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateAppCategoryFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="180px">
        ...
        <el-form-item label="类型ID:"  prop="codeId" >
          <el-input v-model="formData.codeId" :clearable="true"  placeholder="请输入" />
        </el-form-item>

<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="服务机构">
             ...
             <el-input v-model.number="searchInfo.serviceId" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="联保代码">
         <el-input v-model="searchInfo.joinCode" placeholder="搜索条件" />

        </el-form-item>
           <el-form-item label="商户类型" prop="mchType">
            <el-select v-model="searchInfo.mchType" clearable placeholder="请选择" @clear="()=>{searchInfo.mchType=undefined}">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="服务机构" prop="serviceId" width="120" />
        <el-table-column align="left" label="联保代码" prop="joinCode" width="120" />
        ...
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateAppUserFunc(scope.row)">变更</el-button>

            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateAppUserFunc(scope.row)">商家认证</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="120px">
        ...
        <el-form-item label="商户类型:"  prop="mchType" >
          <el-select v-model="formData.mchType" placeholder="请选择" style="width:100%" :clearable="false" >
            <el-option v-for="(item,key) in mchTypeOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
